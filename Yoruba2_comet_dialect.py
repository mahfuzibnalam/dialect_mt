...
parser.add_argument("--lang", help="echo the string you use here", default="Yoruba")
parser.add_argument("--lang_code", help="echo the string you use here", default="yor")
args = parser.parse_args()

model = load_from_checkpoint(f"/home/mahfuz/Research/MachineTranslation/COMET/wmt22-comet-da/checkpoints/model.ckpt")

dialects = "Standard;Central"
